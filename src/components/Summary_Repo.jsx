...
function SectionCard({ section, idx }) {
  ...
  return (
    <Box sx={{ mb: { xs: 3, sm: 4 }, fontFamily: reportFont }}>
      ...
      >
        <Box>
          <Typography variant="h6" fontWeight="600" sx={{ color: headerTextColor, mb: 0, letterSpacing: 0.2, fontSize: { xs: 16, sm: 18 } }}>
            {section.name}
          </Typography>
        ...
        <Box sx={{ textAlign: "right" }}>
          <Typography variant="h5" fontWeight="700" sx={{ color: "#111", mb: 0, fontSize: { xs: 18, sm: 24 } }}>
      ...
      <Card variant="outlined" sx={{ borderRadius: "0 0 16px 16px", bgcolor: "background.paper", pt: 2, pb: 2, fontFamily: reportFont }}>
        <Box sx={{ px: { xs: 2, sm: 4 } }}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <Typography fontWeight="bold" color={green[700]} mb={1}>Strengths</Typography>
              {section.strengths.length === 0 ? (
                <Typography variant="body2" fontStyle="italic" sx={{ color: "#999" }}>No strengths identified in this category</Typography>
              ) : (
                <List dense>
            ...
            <Grid item xs={12} md={4}>
              <Typography fontWeight="bold" color={red[700]} mb={1}>Gaps</Typography>
              {section.gaps.length === 0 ? (
                <Typography variant="body2" fontStyle="italic" sx={{ color: "#999" }}>No gaps identified in this category</Typography>
              ) : (
                <List dense>
            ...
            <Grid item xs={12} md={4}>
              <Typography fontWeight="bold" color={blue[700]} mb={1}>Action Recommendations</Typography>
              {section.recommendations.length === 0 ? (
                <Typography variant="body2" fontStyle="italic" sx={{ color: "#999" }}>No recommendations identified in this category</Typography>
              ) : (
                <List dense>
