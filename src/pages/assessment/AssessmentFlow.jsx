...
//   // Fetch and refresh data from DB on mount
//   useEffect(() => {
...
//   // Fetch all answer options for each question after questions are loaded
//   useEffect(() => {
//     if (questions.length) {
//       questions.forEach(q => {
...
//   // Build the nested structure using memoization to avoid unnecessary recalculation
...
//   // Dynamically set up responses array whenever surveySections change
